...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| form-contract-uncontrolled | K1 | agrees | 0 | 0 | 0 | 3 | 0 | 1 | 31 | 192 |
...
| form-contract-uncontrolled | K2 | agrees | 1 | 42 | 5 | 8 | 1 | 1 | 31 | 192 |
...
| subject | scenario | agreement | commits | changed fibers | host fibers | DOM attrs | DOM nodes | validator passes | paths judged | tree fibers |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| form-contract-uncontrolled | K1 | agrees | 0 | 0 | 0 | 3 | 0 | 1 | 61 | 372 |
...
| form-contract-uncontrolled | K2 | agrees | 1 | 72 | 5 | 8 | 1 | 1 | 61 | 372 |
...
| subject | scenario | agreement | commits | changed fibers | host fibers | DOM attrs | DOM nodes | validator passes | paths judged | tree fibers |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| form-contract-uncontrolled | K1 | agrees | 0 | 0 | 0 | 3 | 0 | 1 | 201 | 1212 |
...
| form-contract-uncontrolled | K2 | agrees | 1 | 212 | 5 | 8 | 1 | 1 | 201 | 1212 |
